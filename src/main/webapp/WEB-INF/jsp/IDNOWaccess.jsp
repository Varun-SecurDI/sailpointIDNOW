...
<br><br><br><br><br>
      ...
      <input type ="number" name="userid" placeholder="UserName" required/>
      <br><br>
      <label for="cp1">Unique Identifier</label>
      <input type ="number" name="cp1" placeholder="Unique Identifier" required/>
      <br><br>
      <button type="Submit" formaction ="/IDNOWgenerate">Generate</button>
